...
class SavoirFormation(models.Model):
    information_personnel = models.ForeignKey(InformationPersonnel, on_delete=models.CASCADE, related_name='savoir_formation')
...
class Ponctualite(models.Model):
    information_personnel = models.ForeignKey(InformationPersonnel, on_delete=models.CASCADE, related_name='ponctualite')
...
class Tenacite(models.Model):
    information_personnel = models.ForeignKey(InformationPersonnel, on_delete=models.CASCADE, related_name='tenacite')
...
class Integration(models.Model):
    information_personnel = models.ForeignKey(InformationPersonnel, on_delete=models.CASCADE, related_name='integration')
    type_personnes_preferees = models.TextField("Avec quels types de personnes aimez-vous le mieux travailler ? Pour quelle raison ?")
    reaction_remarque_negative = models.TextField("Un collègue vous fait une remarque négative sur la qualité de votre travail. Comment réagissez-vous ?")
    depasse_par_situation = models.TextField("Avez-vous déjà été dépassé par la situation ? Donnez-moi un exemple.")

class SensDuService(models.Model):
    information_personnel = models.ForeignKey(InformationPersonnel, on_delete=models.CASCADE, related_name='sens_du_service')
...
class Autonomie(models.Model):
    information_personnel = models.ForeignKey(InformationPersonnel, on_delete=models.CASCADE, related_name='autonomie')
...
class Organisation(models.Model):
    information_personnel = models.ForeignKey(InformationPersonnel, on_delete=models.CASCADE, related_name='organisation')
...
class Satisfaction(models.Model):
    information_personnel = models.ForeignKey(InformationPersonnel, on_delete=models.CASCADE, related_name='satisfaction')
...
class TestTechniquePython(models.Model):
    information_personnel = models.ForeignKey(InformationPersonnel, on_delete=models.CASCADE, related_name='test_technique_python')
...
class TestTechniqueJavaScript(models.Model):
    information_personnel = models.ForeignKey(InformationPersonnel, on_delete=models.CASCADE, related_name='test_technique_javascript')
...
class TestTechniqueFullstack(models.Model):
    information_personnel = models.ForeignKey(InformationPersonnel, on_delete=models.CASCADE, related_name='test_technique_fullstack')
