          ...
          <div className="progress">
            <ul className='progress-steps'>
              <li className="step active">
                <span>1</span>
                <p>Information personnel <br /> 1 min</p>
              </li>

              <li className="step">
                <span>2</span>
                <p>Savoir-Formation<br /> 1 min</p>
              </li>

              <li className="step">
                <span>3</span>
                <p>Ponctualité<br /> 1 min</p>
              </li>

              <li className="step">
                <span>4</span>
                <p>Tenacité<br /> 1 min</p>
              </li>
              ...
              <li className="step">
                <span>6</span>
                <p>Capacité d'intégration<br /> 1 min</p>
              </li>

              <li className="step">
                <span>7</span>
                <p>Sens du service<br /> 1 min</p>
              </li>

              <li className="step">
                <span>8</span>
                <p>Autonomie<br /> 1 min</p>
              </li>

              <li className="step">
                <span>9</span>
                <p>Organisation<br /> 1 min</p>
              </li>

              <li className="step">
                <span>10</span>
                <p>Satisfaction<br /> 1 min</p>
              </li>
            </ul>
          </div>

          <form action="" className='formulaire'>
            <div className="form1 form-step active">
            ...
            <div className="btn-group">
                <button type='button' className='btn-retour' disabled>Retour</button>
