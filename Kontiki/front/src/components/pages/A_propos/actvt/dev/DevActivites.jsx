        ...
        <>
            ...
            <section className="dark:bg-white dark:text-gray-800">
                <div className="container p-6 mx-auto space-y-6 text-center lg:p-8 lg:space-y-8">
                    ...
                    <div className="flex justify-center mt-2">
                        <div className="w-24 h-1 bg-amber-500 mb-20"></div>
                    </div>
                    ...
                    <div className="flex flex-wrap justify-center lg:justify-between mb-20 pb-52 pt-20">

                        <svg className='hover:scale-75 transition-all' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="96" height="96" viewBox="0 0 48 48">
                        ...
                        <svg className='hover:scale-75 transition-all' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="96" height="96" viewBox="0 0 64 64">
